...
Microservices architecture took the world by the storm from as early as 2011 \cite{fowlerOnMicroservices}, with major companies, such as Facebook, Amazon or Netflix, utilizing this architectural style with great success.\todo{the microservice statement needs a reference}
...
Above is not a definitive list and it is probable that as research progresses it may grow to include additional factors should they enhance the accuracy of the prediction model. It remains to be established if any of the below factors have any effect on the bug prediction accuracy:
\begin{enumerate}
